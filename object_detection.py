    ...
    for box in boxes:
        ...
        if label >= 0:
            ...
            if tf:
                ...
                cv2.waitKey(5)
                cv2.imwrite("C:/project/Traffic-Signal-Violation-Detection-System-master/Detected Images/violation_"+str(dcnt)+".jpg", cimg)
                dcnt = dcnt+1
            else:
...
weights_path = "C:/project/Traffic-Signal-Violation-Detection-System-master/yolov3.weights"
# set some parameters
net_h, net_w = 416, 416
